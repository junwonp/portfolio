...
description: Frontend freelance contract for a FinCert-based promotion platform covering signup, consent, events, challenges, rewards, notifications, and account flows.
