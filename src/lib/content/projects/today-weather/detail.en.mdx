...
description: Personalized weather and lifestyle guide using KMA and Air Korea data — monorepo serving web, Expo mobile, and iOS widgets from a single shared logic layer.
date: '2026-04 ~'
role: 'Solo developer'
...
<ProjectLightbox variant="phone" images={[
  {
    src: '/images/today-weather/web-home.png',
    alt: "Today's Weather web app home screen",
    caption: 'Mobile web home screen showing current weather, lifestyle alerts, and outfit, umbrella, and mask decisions from KMA and Air Korea data'
  },
]} />
