...
export const defaultProfile: Record<Language, ProfileData> = {
  en: {
    ...
    metrics: [
      ...
      { value: '#57', label: 'Google Play Entertainment' },
    ],
    pillars: [
      {
        index: '01',
        ...
        description:
          'Building production UI, server-state, and release workflows for React and React Native products.',
      },
      {
        index: '02',
  ...
  ko: {
    ...
    metrics: [
      ...
      { value: '46분', label: '평균 세션 길이' },
      { value: '#57', label: '구글 플레이 엔터테인먼트' },
    ],
    pillars: [
      {
        index: '01',
        ...
        description:
          'React, React Native 제품에서 UI, 서버 상태, 배포 흐름까지 운영 가능한 구조로 만듭니다.',
      },
      {
        index: '02',
        title: '크로스플랫폼 제품 출시',
