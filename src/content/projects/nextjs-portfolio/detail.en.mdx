...
metrics:
  [
    ...
    { value: 'MDX/TS', label: 'Repository content' },
  ]
...
summaryDetails:
  [
    ...
    '**[Cloudflare Full-Stack Bindings]** Uses D1 for analytics and role-fit application short URLs, R2 for media assets, and KV for caching in a Workers-oriented runtime.',
