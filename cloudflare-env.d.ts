/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: efb85ad815eaf4856121938d8ce25432)
...
interface __BaseEnv_CloudflareEnv {
	...
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* portfolio-develop */ | Service<typeof import("./.open-next/worker").default>;
}
declare namespace Cloudflare {
	...
	interface DevelopEnv {
		...
		ADMIN_PASSWORD: string;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* portfolio-develop */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_PASSWORD" | "NEXTJS_ENV">> {}
}
